...
@Component
public class PIC2PRESTAMOService {

	private static final Logger logger = LogManager.getLogger(PIC2PRESTAMOService.class);
	...
	public Map<String, Object> obtenerSIZTMHRPYF022Bean(String expSolicita, String fechaRef, String idMovimiento,
		...
		logger.debug("PIC2PRESTAMOService -> obtenerSIZTMHRPYF022Bean(...)");
